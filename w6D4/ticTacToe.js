...
(function (root) {
  ...
  var Game = TTT.Game = function TT($gameSpace) {
  ...
  // G// ame.prototype.printBoard = function () {
//     var game = this;
//
...
//   }
  ...
  Game.prototype.setUpSquares = function() {
    var htmlString = "";
    var ele = this.$el;
    _.times(9, function(idx) {
      var newDivId = Game.positions[idx];
      htmlString = "<div class='square' id='" + newDivId + "'></div>";
  ...
  Game.prototype.setUpEvents = function() {
    ...
    debugger
    this.$el.click('.square', function() {console.log("click");});
  };
